...
W tej części definiuję specyfikacje modeli, które będą trenowane. Modele drzewiaste będą przewidywać czas dostawy w minutach, a modele liniowe - zlogarytmowany czas dostawy. Ustaliłam 5-krotną walidację z warstwowaniem.
...
grid_xgb <- grid_random(xgb_params, size = 80)
